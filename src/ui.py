...
def show_banner():
    ...
    console.print(Panel.fit("Sistema de monitoramento e análise por IA generativa.\nUse /help para ver os comandos · /exit para sair.\nModelo: gpt-oss:120b via Ollama Cloud",title="◆ MISSION CONTROL", border_style="#06B6D4"))
